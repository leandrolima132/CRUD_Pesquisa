...
import DataTableEntrevistado from './DataTableEntrevistado'

class ComecoEntrevistado extends Component {
  state = {
    items: []
  }
  ...
  getItems() {
    fetch(`http://localhost:3333/ListaPesquisasVazias/`)
      ...
      <Container>
        <div class=" card "  >
          <div class="card-body ">
            ...
            <Row>
              <Col>
                <DataTableEntrevistado items={this.state.items} updateState={this.updateState} deleteItemFromState={this.deleteItemFromState} />
              </Col>
            </Row>
          </div>
        </div>
...
export default ComecoEntrevistado